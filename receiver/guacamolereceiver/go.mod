module github.com/guacamole-otel/guacamolereceiver

// Standalone module for the Guacamole scraper receiver. For an
// opentelemetry-collector-contrib submission the module path becomes
// github.com/open-telemetry/opentelemetry-collector-contrib/receiver/guacamolereceiver
// and internal/metadata is generated by mdatagen from metadata.yaml.
// Concrete dependency versions are resolved by `go mod tidy`.
